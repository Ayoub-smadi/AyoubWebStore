  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-6">Our Collection</h1>
          <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center">
            <div className="relative w-full md:w-96">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
              <Input 
                placeholder="Search products..." 
                className="pl-10 h-12 rounded-xl bg-card border-border focus-visible:ring-primary"
                value={search}
        ...
        {isLoading ? (
          ...
          <div className="text-center py-32 bg-card rounded-3xl border border-border border-dashed">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              We couldn't find anything matching your current filters. Try a different search term or category.
            </p>
                ...
                <div className="group cursor-pointer bg-card rounded-3xl border border-border/50 overflow-hidden hover-elevate h-full flex flex-col shadow-sm">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4">
                      ...
                      {product.stock === 0 ? (
                        <span className="text-xs font-semibold text-destructive uppercase tracking-wider">Out of Stock</span>
                      ) : (
